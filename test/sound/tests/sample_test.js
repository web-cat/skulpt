describe('Sample', function () {
  var mod, getSound, initializeSound, context;
  ...
  describe('__str__', function () {
    ...
    it('should yield a descriptive string containing the classname, the index and the value', function () {
      var str;

      str = sample.__str__(sample);

      assert.instanceOf(str, Sk.builtin.str);
      assert.strictEqual(str.getValue(), 'Sample at 20 with value 123');
    });
  });
  ...
  describe('setSampleValue', function () {
    ...
    describe('procedural', function () {
      it('should take the sample', function () {
        ...
        execFunc = function () { mod.setSampleValue(sample, 10); };
        assert.doesNotThrow(execFunc, Sk.builtin.TypeError);
      });
    ...
    describe('procedural', function () {
      it('should take the sample', function () {
        ...
        execFunc = function () { sample.setSampleValue(sample, 10); };
        assert.doesNotThrow(execFunc, Sk.builtin.TypeError);
      });
